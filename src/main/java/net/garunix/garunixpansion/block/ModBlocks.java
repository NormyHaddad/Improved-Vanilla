...
public class ModBlocks {
    ...
    public static final Block MAPLE_FENCE_GATE = registerBlock("maple_fence_gate", new FenceGateBlock(
            WoodType.CHERRY, FabricBlockSettings.copyOf(Blocks.CHERRY_FENCE_GATE).mapColor(MapColor.OFF_WHITE)), ItemGroups.BUILDING_BLOCKS);
    //endregion

    //Other
    public static final Block MAPLE_TRAPDOOR = registerBlock("maple_trapdoor", new TrapdoorBlock(
            ModBlockSetType.MAPLE, FabricBlockSettings.copyOf(Blocks.CHERRY_TRAPDOOR).mapColor(MapColor.OFF_WHITE)), ItemGroups.BUILDING_BLOCKS);
    public static final Block MAPLE_DOOR = registerBlock("maple_door", new DoorBlock(
            ModBlockSetType.MAPLE, FabricBlockSettings.copyOf(Blocks.CHERRY_DOOR).mapColor(MapColor.OFF_WHITE)), ItemGroups.BUILDING_BLOCKS);
    public static final Block MAPLE_SIGN = registerItemlessBlock("maple_sign", new SignBlock(
            ModWoodType.MAPLE, FabricBlockSettings.copyOf(Blocks.CHERRY_SIGN).mapColor(MapColor.OFF_WHITE)));
    ...
    public static final Block MAPLE_HANGING_SIGN = registerItemlessBlock("maple_hanging_sign", new HangingSignBlock(
            ModWoodType.MAPLE, FabricBlockSettings.copyOf(Blocks.CHERRY_HANGING_SIGN).mapColor(MapColor.OFF_WHITE)));
    public static final Block MAPLE_WALL_HANGING_SIGN = registerItemlessBlock("maple_wall_hanging_sign", new WallHangingSignBlock(
            ModWoodType.MAPLE, FabricBlockSettings.copyOf(Blocks.CHERRY_WALL_HANGING_SIGN).mapColor(MapColor.OFF_WHITE)));
    public static final Block MAPLE_PRESSURE_PLATE = registerBlock("maple_pressure_plate", new PressurePlateBlock(
            ModBlockSetType.MAPLE, FabricBlockSettings.copyOf(Blocks.CHERRY_PRESSURE_PLATE).mapColor(MapColor.OFF_WHITE)), ItemGroups.BUILDING_BLOCKS);
    public static final Block MAPLE_BUTTON = registerBlock("maple_button", new ButtonBlock(
            ModBlockSetType.MAPLE, 30, FabricBlockSettings.copyOf(Blocks.CHERRY_BUTTON).mapColor(MapColor.OFF_WHITE)), ItemGroups.BUILDING_BLOCKS);
    //endregion
    ...
    public static final Block MAHOE_FENCE_GATE = registerBlock("mahoe_fence_gate", new FenceGateBlock(
            ModWoodType.MAHOE, FabricBlockSettings.copyOf(Blocks.JUNGLE_FENCE_GATE).mapColor(MapColor.TERRACOTTA_LIGHT_BLUE)), ItemGroups.BUILDING_BLOCKS);
    //Other
    public static final Block MAHOE_DOOR = registerBlock("mahoe_door", new DoorBlock(
            ModBlockSetType.MAHOE, FabricBlockSettings.copyOf(Blocks.JUNGLE_DOOR).mapColor(MapColor.LIGHT_BLUE_GRAY)), ItemGroups.BUILDING_BLOCKS);
    public static final Block MAHOE_TRAPDOOR = registerBlock("mahoe_trapdoor", new TrapdoorBlock(
            ModBlockSetType.MAHOE, FabricBlockSettings.copyOf(Blocks.JUNGLE_TRAPDOOR).mapColor(MapColor.LIGHT_BLUE_GRAY)), ItemGroups.BUILDING_BLOCKS);

    public static final Block MAHOE_PRESSURE_PLATE = registerBlock("mahoe_pressure_plate", new PressurePlateBlock(
            ModBlockSetType.MAHOE, FabricBlockSettings.copyOf(Blocks.JUNGLE_PRESSURE_PLATE).mapColor(MapColor.TERRACOTTA_LIGHT_BLUE)), ItemGroups.BUILDING_BLOCKS);

    public static final Block MAHOE_BUTTON = registerBlock("mahoe_button", new ButtonBlock(
            ModBlockSetType.MAHOE, 30, FabricBlockSettings.copyOf(Blocks.JUNGLE_BUTTON).mapColor(MapColor.TERRACOTTA_LIGHT_BLUE)), ItemGroups.BUILDING_BLOCKS);
    public static final Block MAHOE_SIGN = registerItemlessBlock("mahoe_sign", new SignBlock(
            ModWoodType.MAHOE, FabricBlockSettings.copyOf(Blocks.CHERRY_SIGN).mapColor(MapColor.LIGHT_BLUE_GRAY)));
    ...
    public static final Block MAHOE_HANGING_SIGN = registerItemlessBlock("mahoe_hanging_sign", new HangingSignBlock(
            ModWoodType.MAHOE, FabricBlockSettings.copyOf(Blocks.CHERRY_HANGING_SIGN).mapColor(MapColor.TERRACOTTA_LIGHT_BLUE)));
    public static final Block MAHOE_WALL_HANGING_SIGN = registerItemlessBlock("mahoe_wall_hanging_sign", new WallHangingSignBlock(
            ModWoodType.MAHOE, FabricBlockSettings.copyOf(Blocks.CHERRY_WALL_HANGING_SIGN).mapColor(MapColor.TERRACOTTA_LIGHT_BLUE)));
    //endregion
    ...
    public static final Block STRANGE_FENCE_GATE = registerBlock("strange_fence_gate", new FenceGateBlock(
            ModWoodType.STRANGE, FabricBlockSettings.copyOf(Blocks.CRIMSON_FENCE).mapColor(MapColor.PALE_PURPLE)), ItemGroups.BUILDING_BLOCKS);
    //endregion

    //region Other
    public static final Block STRANGE_DOOR = registerBlock("strange_door", new DoorBlock(
            ModBlockSetType.STRANGE, FabricBlockSettings.copyOf(Blocks.CRIMSON_DOOR).mapColor(MapColor.PALE_PURPLE)), ItemGroups.BUILDING_BLOCKS);
    public static final Block STRANGE_TRAPDOOR = registerBlock("strange_trapdoor", new TrapdoorBlock(
            ModBlockSetType.STRANGE, FabricBlockSettings.copyOf(Blocks.CRIMSON_TRAPDOOR).mapColor(MapColor.PALE_PURPLE)), ItemGroups.BUILDING_BLOCKS);
    public static final Block STRANGE_PRESSURE_PLATE = registerBlock("strange_pressure_plate", new PressurePlateBlock(
            ModBlockSetType.STRANGE, FabricBlockSettings.copyOf(Blocks.CRIMSON_PRESSURE_PLATE).mapColor(MapColor.TERRACOTTA_LIGHT_BLUE)), ItemGroups.BUILDING_BLOCKS);
    public static final Block STRANGE_BUTTON = registerBlock("strange_button", new ButtonBlock(
            ModBlockSetType.STRANGE,
            30, FabricBlockSettings.copyOf(Blocks.CRIMSON_BUTTON).mapColor(MapColor.TERRACOTTA_LIGHT_BLUE)), ItemGroups.BUILDING_BLOCKS);
    public static final Block STRANGE_SIGN = registerItemlessBlock("strange_sign", new SignBlock(
            ModWoodType.STRANGE, FabricBlockSettings.copyOf(Blocks.CHERRY_SIGN).mapColor(MapColor.PALE_PURPLE)));
    public static final Block STRANGE_WALL_SIGN = registerItemlessBlock("strange_wall_sign", new WallSignBlock(
            ModWoodType.STRANGE, FabricBlockSettings.copyOf(ModBlocks.STRANGE_SIGN).mapColor(MapColor.PALE_PURPLE)));
    public static final Block STRANGE_HANGING_SIGN = registerItemlessBlock("strange_hanging_sign", new HangingSignBlock(
            ModWoodType.STRANGE, FabricBlockSettings.copyOf(Blocks.CHERRY_HANGING_SIGN).mapColor(MapColor.PALE_PURPLE)));
    public static final Block STRANGE_WALL_HANGING_SIGN = registerItemlessBlock("strange_wall_hanging_sign", new WallHangingSignBlock(
            ModWoodType.STRANGE, FabricBlockSettings.copyOf(ModBlocks.STRANGE_HANGING_SIGN).mapColor(MapColor.PALE_PURPLE)));
    //endregion
    //endregion

    //region Misc
    public static final Block SMOOTH_SMOKY_QUARTZ_BLOCK = registerBlock("smooth_smoky_quartz_block",
            new TranslucentBlock(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).mapColor(MapColor.TERRACOTTA_BROWN).nonOpaque()),
            ItemGroups.NATURAL);
    ...
    public static final Block RED_ROSE = registerBlock("red_rose",
            new FlowerBlock(StatusEffects.NIGHT_VISION, 5, FabricBlockSettings.copyOf(Blocks.POPPY)
                    .mapColor(MapColor.DARK_GREEN)), ItemGroups.NATURAL);
    ...
    public static final Block RED_ROSE_CROP = registerBlock("red_rose_crop",
            new OldRoseCrop(FabricBlockSettings.copyOf(Blocks.TORCHFLOWER_CROP)
                    .mapColor(MapColor.DARK_GREEN)), ItemGroups.SEARCH);
    public static final Block CYAN_ROSE_CROP = registerBlock("cyan_rose_crop",
            new CyanRoseCrop(FabricBlockSettings.copyOf(Blocks.TORCHFLOWER_CROP)
                    .mapColor(MapColor.DARK_GREEN)), ItemGroups.SEARCH);
    public static final Block BIRD_OF_PARADISE = registerBlock("bird_of_paradise",
            new TallFlowerBlock(FabricBlockSettings.copyOf(Blocks.ROSE_BUSH)), ItemGroups.NATURAL);
    public static final Block PINK_ORCHID = registerBlock("pink_orchid",
            new FlowerBlock(StatusEffects.SATURATION, 5, FabricBlockSettings.copyOf(Blocks.BLUE_ORCHID)), ItemGroups.NATURAL);
    //endregion
